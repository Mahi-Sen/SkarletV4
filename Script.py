...
ғɪʀsᴛ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ" ʙᴜᴛᴛᴏɴ, ᴛʜᴇɴ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "ʀᴇᴏ̨ᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ" ʙᴜᴛᴛᴏɴ.
...
‼️ ᴄʜᴇᴄᴋ ᴘʀᴏᴏꜰ ʜᴇʀᴇ : @Dev77_xD_Proofs
...
❏ ɴᴏ ʟɪɴᴋꜱ, ᴅɪʀᴇᴄᴛ ғɪʟᴇꜱ
❏ ᴀᴅ-ғʀᴇᴇ & ʜɪɢʜ-sᴘᴇᴇᴅ ᴅᴏᴡɴʟᴏᴀᴅꜱ
❏ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇꜱ & sᴇʀɪᴇꜱ
❏ ᴍᴜʟᴛɪ-ᴘʟᴀʏᴇʀ sᴛʀᴇᴀᴍɪɴɢ
❏ ꜰᴀsᴛ ʀᴇǫᴜᴇsᴛ ᴄᴏᴍᴘʟᴇᴛɪᴏɴ (<1ʜ)*
❏ ᴄᴏᴍᴘʟᴇᴛᴇ ᴀᴅᴍɪɴ sᴜᴘᴘᴏʀᴛ

<blockquote>🎖️ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴꜱ:</blockquote>
 ❏ 𝟶𝟷𝟶₹    ➠    𝟶𝟷 ᴡᴇᴇᴋꜱ
 ❏ 𝟶𝟹5₹    ➠    𝟶𝟷 ᴍᴏɴᴛʜ
 ❏ 𝟶𝟼5₹    ➠    𝟶𝟸 ᴍᴏɴᴛʜ
 ❏ 𝟷𝟶𝟶₹    ➠    𝟶𝟹 ᴍᴏɴᴛʜ
...
<blockquote>💵 ᴘᴀʏᴍᴇɴᴛ:</blockquote>
❏ ᴜᴘɪ ɪᴅ: <code>dev77xd@upi</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
❏ ǫʀ ᴄᴏᴅᴇ: <a href='https://envs.sh/ZPI.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ ǫʀ</a>

📸 ᴘᴀʏᴍᴇɴᴛ ᴘʀᴏᴏғ: @Dev77_xD_Proofs

‼️ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀꜰᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ ᴍᴀɴᴅᴀᴛᴏʀʏ.

⚜️ ᴄʜᴇᴄᴋ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ: /myplan
</b>
</b>"""    
...
-----------Set Imdb Template-----------
/set_template - set IMDb template <a href="https://t.me/HowToVerify_xD/30">Example</a>
--------------Set Tutorial-------------
